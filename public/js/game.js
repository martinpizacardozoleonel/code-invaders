const Game = (() => {
  ...
  function startLevel(lvl){
    ...
    if(levelData.isBoss){
      bossDodge=true; bossDodgeState='playing';
  ...
  function updateBossDodge(){
    ...
    bossX+=Math.sin(frameCount*0.02)*1.5;
    bossX=Math.max(60,Math.min(CW-60,bossX));
    bossTagTimer+=dt;

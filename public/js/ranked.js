const Ranked={
 ...
 renderTournamentBanner(data){
  ...
  if(tournament&&tournament.status==='active'){
   ...
   banner.innerHTML=`<div class="tournament-finished-anim"><div class="tournament-confetti"></div><h2 class="tournament-finished-title">🏆 ¡TORNEO FINALIZADO! 🏆</h2><p class="tournament-finished-sub">¡Felicidades a los ganadores! Revisa el ranked y tus notificaciones.</p><div class="tournament-finished-shine"></div></div><div class="tournament-rewards"><p class="tournament-rewards-title">🎁 Recompensas entregadas</p><div class="tournament-rewards-grid"><div class="tournament-reward reward-1"><span class="reward-pos">🥇 1°</span><span class="reward-item">5000 EXP + 30000 pts + Marco Campeón + Nave Silver</span></div><div class="tournament-reward reward-2"><span class="reward-pos">🥈 2°</span><span class="reward-item">Nave Silver + 3000 EXP + 10000 pts</span></div><div class="tournament-reward reward-3"><span class="reward-pos">🥉 3°</span><span class="reward-item">2000 EXP + 5000 pts</span></div><div class="tournament-reward reward-4"><span class="reward-pos">🎯 4°+</span><span class="reward-item">5000 pts</span></div></div></div>`;
  } else {
   this.stopClock();
   banner.className='tournament-banner tournament-pending';
   banner.innerHTML=`<div class="tournament-top"><div class="tournament-status"><span class="tournament-status-dot pending"></span><span>⏳ TORNEO PRÓXIMAMENTE — 15 días a las 00:00</span></div></div><div class="tournament-players-needed"><p class="tournament-players-count">${playerCount} / ${minPlayers} jugadores</p><p class="tournament-players-hint">Faltan <strong>${Math.max(0,minPlayers-playerCount)}</strong> para iniciar.</p><div class="tournament-progress-bar"><div class="tournament-progress-fill" style="width:${Math.min(100,(playerCount/minPlayers)*100)}%"></div></div></div><div class="tournament-rewards"><p class="tournament-rewards-title">🎁 Recompensas</p><div class="tournament-rewards-grid"><div class="tournament-reward reward-1"><span class="reward-pos">🥇 1°</span><span class="reward-item">5000 EXP + 30000 pts + Marco Campeón + Nave Silver</span></div><div class="tournament-reward reward-2"><span class="reward-pos">🥈 2°</span><span class="reward-item">Nave Silver + 3000 EXP + 10000 pts</span></div><div class="tournament-reward reward-3"><span class="reward-pos">🥉 3°</span><span class="reward-item">2000 EXP + 5000 pts</span></div><div class="tournament-reward reward-4"><span class="reward-pos">🎯 4°+</span><span class="reward-item">5000 pts</span></div></div></div>${canStart?'<p class="tournament-ready">✅ ¡Ya hay suficientes jugadores!</p>':''}`;
  }
 },
